...
python /jetson/models/research/object_detection/mongoose_detect.py $_camera_ip $_iface $_weight_path | kafkacat -b manna.mmmi-lab,hou.mmmi-lab,bisnap.mmmi-lab -t outdoor_wall
